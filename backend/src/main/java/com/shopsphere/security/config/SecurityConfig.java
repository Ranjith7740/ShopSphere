...
public class SecurityConfig {
    ...
    /**
     * Allows the Angular dev server to call this API from the browser. Restricted to the
     * dev server's own origin (not a wildcard) since credentials/Authorization headers are in play.
     */
    @Bean
